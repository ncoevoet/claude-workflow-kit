...
[![version](https://img.shields.io/badge/version-0.9.1-blue)](.claude-plugin/plugin.json)
...
**Context cost, stated honestly:** the three injected documents are 19471 bytes (~19 KB)
